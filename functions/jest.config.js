module.exports = {
  ...
  // firebase.e2e.json). ⚠️ It is excluded here rather than left to fail
  ...
  testPathIgnorePatterns: [
    ...
    // ⚠️ GENERALISED from 'familyEmulator' to ANY *Emulator suite (W2-101).
    ...
    // *Emulator.test.ts is an emulator suite, both ways. 📌 W2-140 moved that
